...
if (empty($_SESSION['userID'])) {
    ...
    <div class='mobile_main mobile_main_active' id='mm1'>
        <div class='m_main'>
            <div class='m_login'><?php if (!empty($_SESSION['userID'])) {
                    echo $_SESSION['user'];
                } ?></div>
    ...
    <div class='mobile_main hidden' id='mm2'>
        <div class='m_main'>
            <div class='m_top_menu_container'>
                ...
                <div class='m_top_menu' id='m_reprint_labels_tab'
                     onclick="openPage('m_reprint_labels', this, 'red','m_modal','tabclass');">RE-PRINT LABELS
                </div>
                <div class='m_top_menu' id='m_search_tab'
                     onclick="openPage('m_search', this, 'red','m_modal','tabclass');">SEARCH
                </div>
            </div>
    ...
    <div class='mobile_main hidden' id='m_temp'>
        ...
        <div class='m_modal2' id='m_temp_modal'>
            <div class='m_label'>
                <spsn>CHECK THE TEMPERATURE</spsn>
            </div>
